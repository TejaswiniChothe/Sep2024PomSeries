...
public class ProductInfoPage {
	...
	public int getProductImagesCount() {
		int imagesCount = eleUtil.waitforElementsPresennce(productImages, AppConstant.SHORT_TIME_OUT).size();
...
//	Availability: In Stock
	...
	private void getProductMetaData() {
		List<WebElement> metaList = eleUtil.waitforElementsPresennce(productMetaData, AppConstant.DEFAULT_TIME_OUT);
...
//	Ex Tax: $2,000.00
	...
	private void getProductPriceData() {
		List<WebElement> priceList = eleUtil.waitforElementsPresennce(productPriceData, AppConstant.DEFAULT_TIME_OUT);
